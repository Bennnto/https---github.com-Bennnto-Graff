...
if __name__ == "__main__":
    test_case("let a = 10 + 20", "a", 30)
    test_case("let b = 50 - 15", "b", 35)
    test_case("let c = 6 * 7", "c", 42)
    test_case("let d = 20 / 4", "d", 5.0)
    test_case("let e = 17 % 5", "e", 2)
    test_case("let f = 2 ** 3", "f", 8)
    test_case("let g = 10 > 5", "g", True)
    test_case("let h = 10 == 10", "h", True)
    test_case("let i = true & false", "i", False)
    test_case("let j = true | false", "j", True)
