...
def test_vm(code, var_name, expected_val):
...
if __name__ == "__main__":
    ...
    test_vm("let x = 15; let y = 25; let z = x + y;", "z", 40)
    test_vm("let a = 10; let b = 3; let res = a % b;", "res", 1)

    # 2. Comparisons & Logic
    test_vm("let x = 10; let is_gt = x > 5;", "is_gt", True)
    test_vm("let a = true; let b = false; let res = a & b;", "res", False)
